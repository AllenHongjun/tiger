    ...
    <el-row :gutter="20">
        ...
        <el-col :span="18">
            <div class="grid-content bg-purple-light">
                <el-table :data="list" :load="loadChildren" :tree-props="{ children: 'children', hasChildren: 'hasChildren' }" style="width: 100%" type="expand" row-key="id" :default-expand-all="false" border fit highlight-current-row lazy>

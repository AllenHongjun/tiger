<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" @sort-change="sortChange">
      ...
      <el-table-column class-name="status-col" label="用户等级" width="110">
        <template slot-scope="{row}">
      ...
      <el-table-column width="80px" align="center" label="累计消费金额">
        <template slot-scope="scope">
          <span>{{ scope.row.forecast }}</span>
        </template>
      </el-table-column>

      <el-table-column width="80px" align="center" label="累计下单次数">
        <template slot-scope="scope">
          <span>{{ scope.row.forecast }}</span>
        </template>
      </el-table-column>

      <el-table-column width="80px" align="center" label="用券次数">
        <template slot-scope="scope">
          <span>{{ scope.row.forecast }}</span>
        </template>
      </el-table-column>

      <el-table-column width="80px" align="center" label="评价数量">
        <template slot-scope="scope">
          <span>{{ scope.row.forecast }}</span>
        </template>
      </el-table-column>

      <el-table-column min-width="80" width="120px" label="退货数量">
        <template slot-scope="{row}">
          <span>{{ row.forecast }}</span>
        </template>
      </el-table-column>

      <el-table-column min-width="80" width="120px" label="登录次数">
        <template slot-scope="{row}">
          <span>{{ row.forecast }}</span>
        </template>
      </el-table-column>

      <el-table-column min-width="80" width="120px" label="关注数量">
        <template slot-scope="{row}">
          <span>{{ row.forecast }}</span>
        </template>
      </el-table-column>

      <el-table-column min-width="80" width="120px" label="粉丝数量">
        <template slot-scope="{row}">
          <span>{{ row.forecast }}</span>
        </template>
      </el-table-column>

      <el-table-column min-width="80" width="120px" label="收藏数量">
        <template slot-scope="{row}">
          <span>{{ row.forecast }}</span>
        </template>
      </el-table-column>

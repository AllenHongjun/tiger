    ...
    <el-row :gutter="0">
      <el-col :span="24">
        <el-row style="margin-bottom: 20px">
          ...
          <el-button type="primary" icon="el-icon-edit" @click="handleCreate">{{ $t("AbpIdentity['New']") }}</el-button>
        ...
        <el-dialog :title="dialogStatus == 'create'? $t('AbpUi[\'NewRole\']'): $t('AbpIdentity[\'Edit\']')" :visible.sync="dialogFormVisible">
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getFeatures(this.listQuery).then((response) => {

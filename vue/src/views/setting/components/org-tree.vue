...
<div class="app-container" style="padding:0 20px;">
    ...
    <el-tree ref="orgTree" :data="orgTreeData" :props="orgTreeProps" :filter-node-method="filterOrg" :expand-on-click-node="false" :show-checkbox="showCheckbox" :check-strictly="checkStrictly" node-key="id" highlight-current default-expand-all @node-click="handleOrgClick" @check-change="checkChange" />
</div>
</template>

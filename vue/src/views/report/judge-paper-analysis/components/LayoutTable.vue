<template>
  <div class="table-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row :stripe="true" style="width: 100%;" @sort-change="sortChange">
      ...
      <el-table-column label="试卷类型" prop="description" align="left">
        <template slot-scope="{ row }">
          <span>随机试卷</span>
        </template>
      </el-table-column>
      <el-table-column label="总分/及格分数" prop="path" align="left">
        <template slot-scope="{ row }">
          <span>35.00/3.00</span>
        </template>
      </el-table-column>
      ...
      <el-table-column :label="$t('AbpUi[\'Actions\']')" align="left" width="210">
        <template slot-scope="{ row, $index }">
          <el-button type="text" title="">评卷</el-button>
        </template>
      </el-table-column>
    </el-table>

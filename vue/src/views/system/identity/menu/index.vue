  ...
  <div class="app-container">
    <div>
      ...
      <el-row style="margin-bottom: 20px">
        <el-input :placeholder="$t('AbpUi[\'PagerSearch\']')" style="width: 150px" class="filter-item" />
        <el-button class="filter-item" type="primary" icon="el-icon-search" />
        <el-button type="primary" icon="el-icon-create" @click="handleCreate">创建</el-button>
        <el-button class="filter-item" style="margin-left: 10px;" icon="el-icon-refresh">{{ $t("AbpIdentity['Refresh']") }}</el-button>
      </el-row>

      <el-table :data="tableData" style="width: 100%;margin-bottom: 20px;" row-key="id" border :default-expand="false" :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
        ...
        <el-table-column align="left" :label="$t('AbpIdentity[\'Actions\']')" width="320">
          <template slot-scope="scope">
            <el-button v-if="checkPermission('AbpIdentity.Roles.Update')" type="primary" plain @click="handleUpdate()">
              {{ $t("AbpIdentity['Edit']") }}
            </el-button>

            <el-button v-if="!scope.row.isStatic && checkPermission('AbpIdentity.Roles.Delete')" type="danger" plain>
          ...
          <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
            ...
            <el-col :span="12">
              <div class="grid-content bg-purple-light">
                <el-form-item label="路由名称" aria-placeholder="路由名称" prop="name">
                  <el-input v-model="ruleForm.name" />
                </el-form-item>
              </div>
            </el-col>
            ...
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-form-item label="路由路径" placeholder="路由路径" prop="name">
                  <el-input v-model="ruleForm.name" />
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="12">
              <div class="grid-content bg-purple-light">
                <el-form-item label="组件路径" aria-placeholder="组件路径" prop="name">
                  <el-input v-model="ruleForm.name" />
                </el-form-item>
              </div>
            </el-col>
            ...
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-form-item label="菜单图标" placeholder="菜单图标" prop="name">
                  <el-input v-model="ruleForm.name" prefix-icon="el-icon-search" />
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="12">
              <div class="grid-content bg-purple-light">
                <el-form-item label="重定向" aria-placeholder="重定向" prop="name">
                  <el-input v-model="ruleForm.name" />
                </el-form-item>
              </div>
            </el-col>
            ...
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-form-item label="链接地址" placeholder="链接地址" prop="name">
                  <el-input v-model="ruleForm.name" />
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="12">
              <div class="grid-content bg-purple-light">
                <el-form-item label="菜单排序" aria-placeholder="菜单排序" prop="name">
                  <el-input-number v-model="num" :min="1" :max="10" label="菜单排序" />
                </el-form-item>
              </div>
            </el-col>
            <el-row>
              ...
              <el-col :span="11">
                <div class="grid-content bg-purple-light">
                  <el-form-item label="固定" prop="resource">
                    <el-radio-group v-model="ruleForm.resource">
                      <el-radio label="是" />
                      <el-radio label="否" />
                    </el-radio-group>

  ...
  <div class="app-container">
    <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="240px" class="demo-ruleForm">
      <el-form-item label="Allowed Identity Token Signing Algorithms" prop="allowedIdentityTokenSigningAlgorithms" clearable>
        <el-select v-model="ruleForm.allowedIdentityTokenSigningAlgorithms" placeholder="请选择">
      ...
      <el-form-item label="Access Token Type" prop="AccessTokenType">
        <el-radio-group v-model="ruleForm.AccessTokenType">
          <el-radio label="JWT">JWT</el-radio>
          <el-radio label="Reference">Reference</el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item label="Include JWT ID" prop="includeJwtId">
        ...
        <el-switch v-model="ruleForm.includeJwtId" :disabled="ruleForm.AccessTokenType !== 'JWT'" />
      </el-form-item>

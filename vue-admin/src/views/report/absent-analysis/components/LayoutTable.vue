<template>
  <div class="table-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row :stripe="true" style="width: 100%;" @sort-change="sortChange">
      ...
      <el-table-column label="类型" prop="description" align="left" width="100">
        <template slot-scope="{ row }">
          <span>考试</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="应参加人次" prop="path" align="left">
        <template slot-scope="{ row }">
          <span>25</span>
        </template>
      </el-table-column>
      <el-table-column label="已参加人次" prop="path" align="left">
        <template slot-scope="{ row }">
          <span>19</span>
        </template>
      </el-table-column>
      <el-table-column label="参考比例" prop="path" align="left">
        <template slot-scope="{ row }">
          <span>23%</span>
        </template>
      </el-table-column>
      <el-table-column label="缺考人数" prop="path" align="left">
        <template slot-scope="{ row }">
          <b style="color:red;">2</b>
        </template>
      </el-table-column>
      <el-table-column label="缺考比例" prop="path" align="left">
        <template slot-scope="{ row }">
          <b>83%</b>
        </template>
      </el-table-column>
      ...
      <el-table-column :label="$t('AbpUi[\'Actions\']')" align="left" width="120">
        <template slot-scope="{ row, $index }">
          <el-button type="text">缺考人员</el-button>
        </template>
      </el-table-column>
    </el-table>

...
namespace Tiger.Volo.Abp.IdentityServer.SmsValidator
{
    public class SmsTokenGrantValidator : IExtensionGrantValidator
    {
        ...
        public SmsTokenGrantValidator(
            ...
            ITigerIdentityUserRepository tigerUserRepository)
        {
            Logger = logger;
            ...
            TigerUserRepository=tigerUserRepository;
        }
        ...
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
            ...
            var currentUser = await TigerUserRepository.FindByPhoneNumberAsync(phoneNumber);
            if (currentUser == null)
            {

...
namespace Tiger.Module.Notifications
{
    ...
    public class DynamicNotificationDefinitionStore
        : IDynamicNotificationDefinitionStore, ITransientDependency
    {
        ...
        //TODO: 创建一个缓存类型
        protected IDistributedCache<NotificationDefinitionsCacheItem> DistributedCache { get; }
        ...
        public DynamicNotificationDefinitionStore(
            ...
            IDistributedCache<NotificationDefinitionsCacheItem> distributedCache,

...
public class CreateUpdateExamDto
{
    ...
    /// </summary>
    [Required]
    [DynamicStringLength(typeof(ExamConsts), nameof(ExamConsts.MaxNameLength))]
    ...
    /// </summary>
    [Required]
    [DynamicStringLength(typeof(ExamConsts), nameof(ExamConsts.MaxCoverLength))]
    ...
    /// </summary>
    [Required]
    [DynamicStringLength(typeof(ExamConsts), nameof(ExamConsts.MaxNumberLength))]
